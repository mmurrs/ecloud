...
console.log();
console.log(`    ${B}Wallet:${R}  ${WALLET}`);
console.log(`    ${B}Credits:${R} ${C}$12.40${R}`);
console.log(`    ${B}USDC:${R}    85.00 USDC (Base)`);
console.log();
console.log(`  ${B}? How much USDC to spend on credits?${R} 50`);
console.log();
console.log(`    Purchasing ${B}$50.00${R} in credits...`);
console.log(`  ${GR}  Approving USDC spend...${R}`);
console.log(`    ${G}✓${R} Approved`);
console.log(`  ${GR}  Submitting credit purchase...${R}`);
console.log(`  ${D}  → USDCCredits.purchaseCreditsFor(50000000, ${WALLET})${R}`);
console.log(`    ${G}✓${R} Transaction confirmed: 0xab12…ef34`);
console.log();
console.log(`  ${GR}  Waiting for credits to appear...${R}`);
console.log(`    ${G}✓${R} Credits received! Balance: ${C}$62.40${R}`);
console.log(`    ${GR}First purchase — up to $25 matched.${R}`);
console.log();
console.log(`  ${D}The CLI executes the tx directly — wallet is already loaded.${R}`);
console.log(`  ${D}Calls: USDC.approve → USDCCredits.purchaseCreditsFor(amount, account)${R}`);
...
console.log(`${GR}  ${"━".repeat(65)}${R}`);
console.log();
console.log(`  ${G}NEW${R}       ecloud billing top-up     Executes purchaseCreditsFor on-chain`);
